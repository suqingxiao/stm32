...
INTEGER32 Target_position = 0xA;		/* Mapped at index 0x607A, subindex 0x00 */
...
UNS8 serverobject_bDeviceNodeId = 0x01;//这个在对象字典里怎么设置不晓得啊那就导致sdo = 600
