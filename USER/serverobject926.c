...
/**************************************************************************/
INTEGER32 can_roll = 0x0;		/* Mapped at index 0x6064, subindex 0x00 */
INTEGER32 can_roll2 = 0x0;		/* Mapped at index 0x6062, subindex 0x00 */
INTEGER32 can_pitch = 0x0;		/* Mapped at index 0x6069, subindex 0x00 */
INTEGER32 can_pitch2 = 0x0;		/* Mapped at index 0x606B, subindex 0x00 */
INTEGER32 can_yaw = 0x0;		/* Mapped at index 0x606C, subindex 0x00 */
INTEGER16 can_yaw222 = 0x0;		/* Mapped at index 0x6078, subindex 0x00 *///不用的东西
INTEGER32 can_yaw2 = 0x0;		/* Mapped at index 0x607A, subindex 0x00 */
...
/* index 0x6062 :   Mapped variable can_roll2 value */
                    subindex serverobject_Index6062[] = 
                     {
                       { RW, int32, sizeof (INTEGER32), (void*)&can_roll2, NULL }
                     };

/* index 0x6064 :   Mapped variable can_roll value */
                    subindex serverobject_Index6064[] = 
                     {
                       { RW, int32, sizeof (INTEGER32), (void*)&can_roll, NULL }
                     };

/* index 0x6069 :   Mapped variable can_pitch value */
                    subindex serverobject_Index6069[] = 
                     {
                       { RW, int32, sizeof (INTEGER32), (void*)&can_pitch, NULL }
                     };

/* index 0x606B :   Mapped variable can_pitch2 value */
                    subindex serverobject_Index606B[] = 
                     {
                       { RW, int32, sizeof (INTEGER32), (void*)&can_pitch2, NULL }
                     };

/* index 0x606C :   Mapped variable can_yaw value */
                    subindex serverobject_Index606C[] = 
                     {
                       { RW, int32, sizeof (INTEGER32), (void*)&can_yaw, NULL }
                     };

/* index 0x6078 :   Mapped variable can_yaw222 value */
                    subindex serverobject_Index6078[] = 
                     {
                       { RW, int16, sizeof (INTEGER16), (void*)&can_yaw222, NULL }
                     };

/* index 0x607A :   Mapped variable can_yaw2 */
                    subindex serverobject_Index607A[] = 
                     {
                       { RW, int32, sizeof (INTEGER32), (void*)&can_yaw2, NULL }
                     };
...
const indextable * serverobject_scanIndexOD (CO_Data *d, UNS16 wIndex, UNS32 * errorCode)
{
	...
	switch(wIndex){
		...
		case 0x6062: i = 21;break;
		case 0x6064: i = 22;break;
		case 0x6069: i = 23;break;
		case 0x606B: i = 24;break;
		case 0x606C: i = 25;break;
		case 0x6078: i = 26;break;
